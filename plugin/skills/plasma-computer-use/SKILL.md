...
2. Prefer `plasma.click_button`, `plasma.set_text_field`, `plasma.select_menu`, `plasma.activate_tab`, `plasma.activate_link`, `plasma.toggle_check`, `plasma.set_value`, and `plasma.focus_window` over raw coordinates.
