...
4. Prefer `plasma.a11y_find`, `plasma.click_button`, `plasma.set_text_field`, `plasma.select_item`, and `plasma.toggle_check` for browser chrome and web UI when AT-SPI exposes the target.
