...
8. Report exact backend names, command errors, policy decisions, active safety gates, and setup hints. Suggest system changes only after the diagnostics show they are needed.
