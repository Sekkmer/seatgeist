...
5. Treat `implemented_available_backend` as the backend PlasmaPilot can execute today; `preferred_available_backend` may name a visible portal/libei path that still needs implementation.
