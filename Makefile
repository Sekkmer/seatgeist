...
verify: fmt check test clippy validate-plugin validate-install-assets validate-traces smoke-trace-replay gui-eval-kwin-bridge-status gui-eval-control-safety
