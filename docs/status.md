...
- Pointer/keyboard input, AT-SPI, MCP wait/change tools, portal/KDE-native clipboard fallback, portal/KWin-native capture backends, persistent active-window bridge installation checks, and richer journal filtering remain future work.
