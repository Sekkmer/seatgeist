...
- Actual portal RemoteDesktop/libei control backends, pointer calibration GUI smoke, richer AT-SPI edit operations, remaining high-level semantic actions, portal/KDE-native clipboard fallback, and portal/KWin-native capture backends remain future work.
