...
- `make smoke-atspi` validates the daemon-backed focused accessibility tree, accessibility find paths, and deny-by-default accessibility invoke/set-text/click-button paths, and confirms the requests are journaled.
