...
- Pointer input, richer AT-SPI edit operations, remaining high-level semantic actions, portal/KDE-native clipboard fallback, and portal/KWin-native capture backends remain future work.
