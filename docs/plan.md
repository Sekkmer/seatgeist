...
- [x] Use AT-SPI first for `click_button`, `set_text_field`, `select_menu`, `activate_tab`, and `toggle_check`; screenshot+coordinate fallback remains future work and must only happen when safe.
