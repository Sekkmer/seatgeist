...
- [~] Public release checklist, external CI, dual license files, local Seatgeist binary/plugin plus source release packaging, verification, and optional GPG signing targets exist; public uploads and signed release tags are not done.
